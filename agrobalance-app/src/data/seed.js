export const seedData = {
  ...
  expenses: [
    { id: 'exp-1', companyId: 'comp-1', cropId: 'crop-1', supplierId: 'sup-1', fecha: '2025-09-10', categoria: 'Semillas', labor: 'Siembra', concepto: 'Semilla Soja', monto: 17000, estado: 'pendiente', horas: null, anual: false },
    { id: 'exp-2', companyId: 'comp-1', cropId: 'crop-1', supplierId: 'sup-1', fecha: '2025-09-22', categoria: 'Fertilizantes', labor: 'Fertilización', concepto: 'Urea', monto: 23000, estado: 'pagado', horas: null, anual: false },
    { id: 'exp-3', companyId: 'comp-1', cropId: 'crop-2', supplierId: 'sup-2', fecha: '2025-10-05', categoria: 'Flete', labor: 'Transporte', concepto: 'Flete maíz', monto: 4500, estado: 'pendiente', horas: null, anual: false },
  ...
  machineryMaintenance: [
    { id: 'mm-1', machineryId: 'mach-1', fecha: '2025-04-15', concepto: 'Cambio de aceite', horas: 5000, costo: 300 },
    { id: 'mm-2', machineryId: 'mach-2', fecha: '2025-07-12', concepto: 'Cubierta', horas: 3600, costo: 500 }
  ],
  employees: [
  ...
  salaryEntries: [
    { id: 'sal-1', employeeId: 'emp-1', mes: '2025-06', tipo: 'Sueldo', monto: 1400 },
    { id: 'sal-2', employeeId: 'emp-1', mes: '2025-06', tipo: 'Aguinaldo', monto: 700 },
    { id: 'sal-3', employeeId: 'emp-2', mes: '2025-06', tipo: 'Sueldo', monto: 1150 },
    { id: 'sal-4', employeeId: 'emp-2', mes: '2025-06', tipo: 'Licencia', monto: 460 }
  ]
};
